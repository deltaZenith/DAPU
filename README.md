...
### Cross compatibility
At the moment, the only supported package managers are APT and pacman, with more to come. The script figures out what package manager is installed using the shutils library and determines the approriate command for each situation through the use of dictionaries.
